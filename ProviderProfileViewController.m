...
-(IBAction)savebtnClick:(id)sender
{
    ...
    {
        [[[UIAlertView alloc]initWithTitle:@"SOS Doctor" message:@"Please enter your name." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    if ([self.Username.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"SOS Doctor" message:@"Please enter your username." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    else if ([Addresstxt.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"SOS Doctor" message:@"Please enter your address." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    else if ([medicalLicensetxt.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"SOS Doctor" message:@"Please enter your medical licence." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
...
-(IBAction)medicalSpecialitySelect:(id)sender
{
        if ([[UIDevice currentDevice]userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
        {
            NSArray *arr=[[NSMutableArray alloc]initWithObjects:@"Family Practitioner", /*@"Internist",*/ nil];
...
//    UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"DoctorSOS" message:@"Camera not available." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
