...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) 
    {
        ...
        bacground.frame = CGRectMake(0.0, 0, frame.size.width, frame.size.height);
        //bacground.contentMode = UIViewContentModeScaleAspectFit;
        // content
        ...
        shadows.frame = CGRectMake(0.0, 0, frame.size.width, frame.size.height);
        //shadows.contentMode = UIViewContentModeScaleAspectFit;
        // glass
...
- (void)tileViews
{
    ...
    NSInteger lastNeededViewIndex  = floorf((CGRectGetMaxY(visibleBounds) / 39.0)) - 2;
