...
- (void)setupImageView {
    _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(12.5f, 12.5f, 32.0f, 32.0f)];
...
- (void)setupDisclosureButton {
    ...
    [_disclosureButton setTitle:@"Select" forState:UIControlStateNormal];
    _disclosureButton.backgroundColor = [UIColor orangeColor];
    [_disclosureButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    _disclosureButton.frame = CGRectMake(kJPSThumbnailAnnotationViewExpandOffset/2.0f + self.frame.size.width/2.0f + 8.0f - 35,
                                         32,
                                         50,
                                         disclosureIndicatorImage.size.height - 10);
...
- (void)updateWithThumbnail:(JPSThumbnail *)thumbnail {
    ...
    self.imageView.image = [UIImage imageNamed:@"ic_bag_hightlight"];//thumbnail.image;ic_bag_selected
