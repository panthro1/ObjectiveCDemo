...
didReceiveRemoteNotification:(NSDictionary *)userInfo
{
    ...
    if (result) {
        ...
        if ([dic objectForKey:@"alert"]) {
            UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"SOS Doctor" message:[dic objectForKey:@"alert"] delegate:nil cancelButtonTitle:@"Close" otherButtonTitles:nil, nil];
            [alert show];
        }
    }
