...
- (CGSize)sizeForItemWithColumnIndex:(NSUInteger)columnIndex
{
    ...
    float widthItem = [UIScreen mainScreen].bounds.size.width/NUMBEROFCOLUMNS;
    ...
    return CGSizeMake([@((IPAD_VERSION ? widthItem : size.width) + 9) floatValue], 57); // Extra space of 9px for all the items
}
