...
-(IBAction)savebtnClick:(id)sender
{
    ...
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter first name." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    if ([_lastNameTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter last name." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    if ([_dateofbirthTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter date of birth" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    if ([_streetAddressTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter street address" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    if ([_ssnTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter SSN" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    if ([_localcityTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter city" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    if ([_regionTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please select state" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    
    if ([_postcodeTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter zip code" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    ...
    if(!name)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter alphabets only (Doesn't support speal symbols)." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    ...
    if ([phonenumber.text isEqualToString:@""]) {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter phone number." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }

    if ([_emailAddressTextField.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter email address." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    ...
    else if ([medicalSpecialitytxt.text length]<=0)
    {
        ...
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please Add Profile Picture." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }else if (medicalLicenseImage == nil) {
       
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please Add Medical License Picture." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    else if ([banknametxt.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter bank name." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    else if ([accountnumbertxt.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter bank account number." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    else if ([routingNumbertxt.text length]<=0)
    {
        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Please enter routing number." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
        return;
    }
    else
    {
        ...
        [[BrainTreeService defaultBraintree] creatSubMerchant:braintreeModel onDone:^(BOOL success, NSString* SubMerchantId) {
            if(success == TRUE)
            {
                ...
                [ProviderDetails signUpInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
                    if (!error) {
                        [self dismissWaiting];
                        [[[UIAlertView alloc]initWithTitle:@"Swurvin" message:@"Successfully created your profile." delegate:self cancelButtonTitle:@"OK" otherButtonTitles: nil] show];
            ...
            {
                [self dismissWaiting];
                UIAlertView *errorAlertView = [[UIAlertView alloc] initWithTitle:@"Swurvin" message:SubMerchantId delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
                [errorAlertView show];
            }
            
        } onError:^(BOOL error) {
            [self dismissWaiting];
            UIAlertView *errorAlertView = [[UIAlertView alloc] initWithTitle:@"Swurvin" message:@"We are sorry, we cannot create your profile at this time. Please try later." delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
            [errorAlertView show];
        }];
    }
}
...
{
    _medicalArr = [[NSMutableArray alloc]initWithObjects: @"Tow Truck Company", nil];
