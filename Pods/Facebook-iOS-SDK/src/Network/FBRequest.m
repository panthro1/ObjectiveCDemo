...
+ (FBRequest *)requestForUpdateOpenGraphObject:(id<FBOpenGraphObject>)object {
    //This issue comes from the lib when building with new xcode. Making workaround here
    NSDictionary* dict = (NSDictionary*)object;
    return [FBRequest requestForUpdateOpenGraphObjectWithId:dict[@"id"] graphObject:object];
}
